...
MULTIMODAL_LEANMOD_CHAT_ADMIN_LIST = [
    'uuid',
    'created_at'
]
MULTIMODAL_LEANMOD_CHAT_ADMIN_FILTER = [
    'uuid',
    'created_at'
]
...
ELECTRON_COPILOT_CONFIGURATION_ADMIN_LIST = [
    'is_active',
    'connection_type_selection',
    'last_toggled_is_active_at'
]
ELECTRON_COPILOT_CONFIGURATION_ADMIN_FILTER = [
    'is_active',
    'connection_type_selection'
]
ELECTRON_COPILOT_CONFIGURATION_ADMIN_SEARCH = [
    'connection_type_selection'
]
...
class ChatRolesNames:
    ...
    def as_list():
        return [
            ChatRolesNames.SYSTEM,
            ChatRolesNames.ASSISTANT,
            ChatRolesNames.USER
        ]
