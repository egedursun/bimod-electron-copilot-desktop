...
from apps.connections.views import (
    ConnectionView_AssistantCreate,
    ConnectionView_AssistantRemove,

    ConnectionView_LeanmodCreate,
    ConnectionView_LeanmodRemove,

    ConnectionView_OrchestrationCreate,
    ConnectionView_OrchestrationRemove,

    ConnectionView_VoidForgerCreate,
    ConnectionView_VoidForgerRemove
)
...
urlpatterns = [
    ...
    path(
        'voidforger/create/',
        ConnectionView_VoidForgerCreate.as_view(
            template_name='connections/create/create_voidforger_connection.html'
        ),
        name='voidforger_create'
    ),
    path(
        'voidforger/remove/',
        ConnectionView_VoidForgerRemove.as_view(
            template_name='connections/remove/remove_voidforger_connections.html'
        ),
